...
#define CEPH_FEATURE_INCARNATION_2 (1ull<<57)              
#define CEPH_FEATURE_INCARNATION_3 ((1ull<<57)|(1ull<<28)) 
...
DEFINE_CEPH_FEATURE(31, 1, MON_SINGLE_PAXOS)  
...
DEFINE_CEPH_FEATURE(41, 1, OSD_PRIMARY_AFFINITY) 
...
DEFINE_CEPH_FEATURE(57, 1, MON_ROUTE_OSDMAP) 
DEFINE_CEPH_FEATURE(57, 1, OSDSUBOP_NO_SNAPCONTEXT) 
DEFINE_CEPH_FEATURE(57, 1, SERVER_JEWEL) 
...
DEFINE_CEPH_FEATURE(60, 1, OSD_RECOVERY_DELETES) 
DEFINE_CEPH_FEATURE(61, 1, CEPHX_V2)             

DEFINE_CEPH_FEATURE(62, 1, RESERVED)           
