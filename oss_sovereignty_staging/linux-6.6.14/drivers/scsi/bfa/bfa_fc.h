...
enum fdmi_hba_attribute_type {
	...
	FDMI_HBA_ATTRIB_NODE_SYM_NAME,   
	FDMI_HBA_ATTRIB_VENDOR_INFO,     
	FDMI_HBA_ATTRIB_NUM_PORTS,   
	FDMI_HBA_ATTRIB_FABRIC_NAME,     
	FDMI_HBA_ATTRIB_BIOS_VER,    
...
enum fdmi_port_attribute_type {
	...
	FDMI_PORT_ATTRIB_NODE_NAME,      
	FDMI_PORT_ATTRIB_PORT_NAME,      
	FDMI_PORT_ATTRIB_PORT_SYM_NAME,  
	FDMI_PORT_ATTRIB_PORT_TYPE,      
	FDMI_PORT_ATTRIB_SUPP_COS,       
	FDMI_PORT_ATTRIB_PORT_FAB_NAME,  
	FDMI_PORT_ATTRIB_PORT_FC4_TYPE,  
	FDMI_PORT_ATTRIB_PORT_STATE = 0x101,     
	FDMI_PORT_ATTRIB_PORT_NUM_RPRT = 0x102,  
