...
void hdmi5_core_ddc_init(struct hdmi_core_data *core)
{
	...
	const unsigned int ss_scl_high = 4700;		 
	const unsigned int ss_scl_low = 5500;		 
	const unsigned int fs_scl_high = 600;		 
	const unsigned int fs_scl_low = 1300;		 
	const unsigned int sda_hold = 1000;		 
