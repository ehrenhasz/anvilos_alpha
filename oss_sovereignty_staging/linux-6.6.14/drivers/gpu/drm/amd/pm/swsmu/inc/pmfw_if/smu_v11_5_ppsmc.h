...
#define PPSMC_MSG_PowerDownIspByTile                   0x6 
#define PPSMC_MSG_PowerUpIspByTile                     0x7
#define PPSMC_MSG_PowerDownVcn                         0x8 
#define PPSMC_MSG_PowerUpVcn                           0x9
#define PPSMC_MSG_RlcPowerNotify                       0xA
#define PPSMC_MSG_SetHardMinVcn                        0xB 
#define PPSMC_MSG_SetSoftMinGfxclk                     0xC 
