...
static const int rk3588_register_offset[] = {
	...
	RK3588_CRU_RESET_OFFSET(SRST_CSIPHY0, 1, 7), 
	RK3588_CRU_RESET_OFFSET(SRST_P_CSIPHY1, 1, 8),
	RK3588_CRU_RESET_OFFSET(SRST_CSIPHY1, 1, 9), 
	...
	RK3588_CRU_RESET_OFFSET(SRST_HDPTX0_ROPLL, 72, 12), 
	RK3588_CRU_RESET_OFFSET(SRST_HDPTX0_LCPLL, 72, 13), 
	RK3588_CRU_RESET_OFFSET(SRST_HDPTX0, 72, 14), 
	RK3588_CRU_RESET_OFFSET(SRST_HDPTX1_ROPLL, 72, 15), 

	 
	RK3588_CRU_RESET_OFFSET(SRST_HDPTX1_LCPLL, 73, 0), 
	RK3588_CRU_RESET_OFFSET(SRST_HDPTX1, 73, 1), 
	RK3588_CRU_RESET_OFFSET(SRST_HDPTX0_HDMIRXPHY_SET, 73, 2), 
	RK3588_CRU_RESET_OFFSET(SRST_USBDP_COMBO_PHY0, 73, 3), 
	RK3588_CRU_RESET_OFFSET(SRST_USBDP_COMBO_PHY0_LCPLL, 73, 4), 
	RK3588_CRU_RESET_OFFSET(SRST_USBDP_COMBO_PHY0_ROPLL, 73, 5), 
	RK3588_CRU_RESET_OFFSET(SRST_USBDP_COMBO_PHY0_PCS_HS, 73, 6), 
	RK3588_CRU_RESET_OFFSET(SRST_USBDP_COMBO_PHY1, 73, 7), 
	RK3588_CRU_RESET_OFFSET(SRST_USBDP_COMBO_PHY1_LCPLL, 73, 8), 
	RK3588_CRU_RESET_OFFSET(SRST_USBDP_COMBO_PHY1_ROPLL, 73, 9), 
	RK3588_CRU_RESET_OFFSET(SRST_USBDP_COMBO_PHY1_PCS_HS, 73, 10), 
