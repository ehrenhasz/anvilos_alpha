...
const struct acpi_opcode_info acpi_gbl_aml_op_info[AML_NUM_OPCODES] = {
  ...
  ACPI_OP("CreateBitField", ARGP_CREATE_BIT_FIELD_OP,
			 ...
			 AML_HAS_ARGS | AML_NSOBJECT | AML_NSNODE |
			 AML_DEFER | AML_CREATE),
  ACPI_OP("ObjectType", ARGP_OBJECT_TYPE_OP, ARGI_OBJECT_TYPE_OP,
			 ACPI_TYPE_ANY, AML_CLASS_EXECUTE,
			 AML_TYPE_EXEC_1A_0T_1R,
			 AML_FLAGS_EXEC_1A_0T_1R | AML_NO_OPERAND_RESOLVE),
  ...
  ACPI_OP("External", ARGP_EXTERNAL_OP, ARGI_EXTERNAL_OP,
			 ACPI_TYPE_ANY, AML_CLASS_NAMED_OBJECT,
			 AML_TYPE_NAMED_SIMPLE,
			 AML_HAS_ARGS | AML_NSOBJECT | AML_NSOPCODE |
			 AML_NSNODE | AML_NAMED),
  ACPI_OP("Comment", ARGP_COMMENT_OP, ARGI_COMMENT_OP,
			 ACPI_TYPE_STRING, AML_CLASS_ARGUMENT,
			 AML_TYPE_LITERAL, AML_CONSTANT)
