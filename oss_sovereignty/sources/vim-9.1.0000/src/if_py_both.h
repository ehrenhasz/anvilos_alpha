...
#define PYTHONX_STRING_LENGTH 7 
...
#define DICT_FLAG_RETURN_BOOL	0x08 
...
static PySequenceMethods ListAsSeq = {
    ...
    (binaryfunc)	0,		 
    0,					 
    (PyIntArgFunc)	ListIndex,	 
    0,					 
    (PyIntObjArgProc)	ListAssIndex,	 
    0,					 
    0,					 
