...
#define NGBE_GPIO_DR_1				BIT(1) 
#define NGBE_GPIO_DDR_0				BIT(0) 
#define NGBE_GPIO_DDR_1				BIT(1) 
...
#define NGBE_PSR_WKUP_CTL_LNKC			BIT(0) 
#define NGBE_PSR_WKUP_CTL_MAG			BIT(1) 
#define NGBE_PSR_WKUP_CTL_EX			BIT(2) 
#define NGBE_PSR_WKUP_CTL_MC			BIT(3) 
#define NGBE_PSR_WKUP_CTL_BC			BIT(4) 
#define NGBE_PSR_WKUP_CTL_ARP			BIT(5) 
#define NGBE_PSR_WKUP_CTL_IPV4			BIT(6) 
#define NGBE_PSR_WKUP_CTL_IPV6			BIT(7) 
