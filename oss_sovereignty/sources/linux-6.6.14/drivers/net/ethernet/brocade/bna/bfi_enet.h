...
#define BFI_ENET_STATS_MAC    BIT(0)    
#define BFI_ENET_STATS_BPC    BIT(1)    
#define BFI_ENET_STATS_RAD    BIT(2)    
#define BFI_ENET_STATS_RX_FC  BIT(3)    
#define BFI_ENET_STATS_TX_FC  BIT(4)    
