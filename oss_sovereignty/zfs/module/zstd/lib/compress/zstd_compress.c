                          ...
                          const int bmi2)
{
    ...
    {   unsigned max = MaxLL;
        size_t const mostFrequent = HIST_countFast_wksp(count, &max, llCodeTable, nbSeq, entropyWorkspace, entropyWkspSize);    
    ...
    {   unsigned max = MaxOff;
        size_t const mostFrequent = HIST_countFast_wksp(
            count, &max, ofCodeTable, nbSeq, entropyWorkspace, entropyWkspSize);   
    ...
    {   unsigned max = MaxML;
        size_t const mostFrequent = HIST_countFast_wksp(
            count, &max, mlCodeTable, nbSeq, entropyWorkspace, entropyWkspSize);    
                             ...
                             ZSTD_EndDirective endOp)
{
    ...
    if (cctx->appliedParams.nbWorkers > 0) {
        ...
        size_t flushMin;
        assert(forceMaxProgress || endOp == ZSTD_e_continue  );
...
{    
    ...
    { 21, 18, 19,  2,  5,  2, ZSTD_greedy  },   
    { 21, 19, 19,  3,  5,  4, ZSTD_greedy  },   
    { 21, 19, 19,  3,  5,  8, ZSTD_lazy    },   
    { 21, 19, 19,  3,  5, 16, ZSTD_lazy2   },   
    { 21, 19, 20,  4,  5, 16, ZSTD_lazy2   },   
    { 22, 20, 21,  4,  5, 16, ZSTD_lazy2   },   
    { 22, 21, 22,  4,  5, 16, ZSTD_lazy2   },   
    { 22, 21, 22,  5,  5, 16, ZSTD_lazy2   },   
    { 22, 21, 22,  5,  5, 32, ZSTD_btlazy2 },   
...
{    
    ...
    { 18, 16, 17,  2,  5,  2, ZSTD_greedy  },   
    { 18, 18, 18,  3,  5,  2, ZSTD_greedy  },   
...
{    
    ...
    { 17, 17, 17,  3,  4,  8, ZSTD_lazy2   },   
    { 17, 17, 17,  4,  4,  8, ZSTD_lazy2   },   
    { 17, 17, 17,  5,  4,  8, ZSTD_lazy2   },   
    { 17, 17, 17,  6,  4,  8, ZSTD_lazy2   },   
