...
#define HAD_DEFAULT_BUFFER	(600 * 1024)  
#define HAD_MAX_PERIODS		256	 
#define HAD_MIN_PERIODS		1
#define HAD_MAX_PERIOD_BYTES	((HAD_MAX_BUFFER / HAD_MIN_PERIODS) & ~0x3f)
#define HAD_MIN_PERIOD_BYTES	1024	 
#define HAD_FIFO_SIZE		0  
...
enum hdmi_ctrl_reg_offset {
	...
	AUD_CNTL_ST		= 0x60,
	AUD_HDMI_STATUS		= 0x64,  
	AUD_HDMIW_INFOFR	= 0x68,  
};
union aud_cfg {
	struct {
		u32 aud_en:1;
