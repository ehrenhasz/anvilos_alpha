...
#define RT5640_DSP_CMD_MW			(0x3B)	 
#define RT5640_DSP_CMD_MR			(0x37)	 
#define RT5640_DSP_CMD_RR			(0x60)	 
#define RT5640_DSP_CMD_RW			(0x68)	 
#define RT5640_REG_SEQ_MASK			(0xf << 12)
#define RT5640_REG_SEQ_SFT			12
#define RT5640_SEQ1_ST_MASK			(0x1 << 11)  
#define RT5640_SEQ1_ST_SFT			11
#define RT5640_SEQ1_ST_RUN			(0x0 << 11)
#define RT5640_SEQ1_ST_FIN			(0x1 << 11)
#define RT5640_SEQ2_ST_MASK			(0x1 << 10)  
...
#define RT5640_WND_WIND_MASK			(0x1 << 13)  
#define RT5640_WND_WIND_SFT			13
#define RT5640_WND_STRONG_MASK			(0x1 << 12)  
