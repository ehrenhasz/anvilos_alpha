...
#define OSMR0  		io_p2v(0x90000000)   
#define OSMR1  		io_p2v(0x90000004)   
#define OSMR2  		io_p2v(0x90000008)   
#define OSMR3  		io_p2v(0x9000000c)   
#define OSCR   		io_p2v(0x90000010)   
#define OSSR   		io_p2v(0x90000014)   
#define OWER   		io_p2v(0x90000018)   
#define OIER  	 	io_p2v(0x9000001C)   
#define OSSR_M(Nb)	        	  \
                	(0x00000001 << (Nb))
