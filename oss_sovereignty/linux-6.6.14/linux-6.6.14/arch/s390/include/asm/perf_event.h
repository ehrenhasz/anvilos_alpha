...
#define PERF_EVENT_CPUM_SF		0xB0000UL  
#define PERF_EVENT_CPUM_SF_DIAG		0xBD000UL  
#define PERF_EVENT_CPUM_CF_DIAG		0xBC000UL  
#define PERF_CPUM_SF_BASIC_MODE		0x0001	   
#define PERF_CPUM_SF_DIAG_MODE		0x0002	   
#define PERF_CPUM_SF_MODE_MASK		(PERF_CPUM_SF_BASIC_MODE| \
					 PERF_CPUM_SF_DIAG_MODE)
#define PERF_CPUM_SF_FREQ_MODE		0x0008	   
#define REG_NONE		0
