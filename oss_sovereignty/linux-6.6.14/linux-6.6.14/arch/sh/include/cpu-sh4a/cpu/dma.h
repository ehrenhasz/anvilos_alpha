...
#define DMAE0_IRQ	evt2irq(0xbc0)	 
...
#define DMTE8_IRQ	evt2irq(0x740)	 
#define DMTE9_IRQ	evt2irq(0x760)
#define DMTE10_IRQ	evt2irq(0xb00)	 
#define DMTE11_IRQ	evt2irq(0xb20)
#define DMAE0_IRQ	evt2irq(0xbc0)	 
#define DMAE1_IRQ	evt2irq(0xb40)	 
#define SH_DMAC_BASE0	0xFE008020
...
#define DMAE0_IRQ	evt2irq(0x6e0)	 
#define DMAE1_IRQ	evt2irq(0x940)	 
#define SH_DMAC_BASE0	0xFC808020
