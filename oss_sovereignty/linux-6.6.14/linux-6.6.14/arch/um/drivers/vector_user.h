...
#endif
#define GRE_MODE_CHECKSUM	cpu_to_be16(8 << 12)	 
#define GRE_MODE_RESERVED	cpu_to_be16(4 << 12)	 
#define GRE_MODE_KEY		cpu_to_be16(2 << 12)	 
#define GRE_MODE_SEQUENCE	cpu_to_be16(1 << 12)	 
