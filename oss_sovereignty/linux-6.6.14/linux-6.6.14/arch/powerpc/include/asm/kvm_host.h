...
#define KVM_HALT_POLL_NS_DEFAULT 10000	 
...
#define KVMPPC_RMAP_NESTED	0xc000000000000000	 
#define KVMPPC_RMAP_HPT		0x0100000000000000	 
...
#define KVMPPC_SECURE_INIT_DONE  0x2  
#define KVMPPC_SECURE_INIT_ABORT 0x4  
struct kvm_arch {
	unsigned int lpid;
...
#define KVMPPC_EPR_NONE		0  
#define KVMPPC_EPR_USER		1  
#define KVMPPC_EPR_KERNEL	2  
#define KVMPPC_IRQ_DEFAULT	0
#define KVMPPC_IRQ_MPIC		1
#define KVMPPC_IRQ_XICS		2  
#define KVMPPC_IRQ_XIVE		3  
...
struct kvm_vcpu_arch {
	...
	struct kvmhv_tb_accumulator *cur_activity;	 
	u64	cur_tb_start;			 
	...
	struct kvmhv_tb_accumulator rm_intr;	 
	struct kvmhv_tb_accumulator rm_exit;	 
	struct kvmhv_tb_accumulator guest_time;	 
	struct kvmhv_tb_accumulator cede_time;	 
#endif
#endif  
};
