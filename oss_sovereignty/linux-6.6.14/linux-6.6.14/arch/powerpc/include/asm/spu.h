...
#define MS_SYNC_PENDING         1L
	...
	u8  pad_0x3000_0x3004[0x4];				 
	u32 mfc_lsa_W;						 
	u64 mfc_ea_W;						 
	union mfc_tag_size_class_cmd mfc_union_W;			 
	u8  pad_0x3018_0x3104[0xec];				 
	u32 dma_qstatus_R;					 
	u8  pad_0x3108_0x3204[0xfc];				 
	u32 dma_querytype_RW;					 
	u8  pad_0x3208_0x321c[0x14];				 
	u32 dma_querymask_RW;					 
	u8  pad_0x3220_0x322c[0xc];				 
	u32 dma_tagstatus_R;					 
#define DMA_TAGSTATUS_INTR_ANY	1u
#define DMA_TAGSTATUS_INTR_ALL	2u
	u8  pad_0x3230_0x4000[0x4000 - 0x3230]; 		 
	u8  pad_0x4000_0x4004[0x4];				 
	u32 pu_mb_R;						 
	u8  pad_0x4008_0x400c[0x4];				 
	u32 spu_mb_W;						 
	u8  pad_0x4010_0x4014[0x4];				 
	u32 mb_stat_R;						 
	u8  pad_0x4018_0x401c[0x4];				 
	u32 spu_runcntl_RW;					 
#define SPU_RUNCNTL_STOP	0L
#define SPU_RUNCNTL_RUNNABLE	1L
#define SPU_RUNCNTL_ISOLATE	2L
	u8  pad_0x4020_0x4024[0x4];				 
	u32 spu_status_R;					 
...
#define SPU_STATUS_ISOLATED_EXIT_STATUS 0x400
	u8  pad_0x4028_0x402c[0x4];				 
	u32 spu_spe_R;						 
	u8  pad_0x4030_0x4034[0x4];				 
	u32 spu_npc_RW;						 
	u8  pad_0x4038_0x14000[0x14000 - 0x4038];		 
	u8  pad_0x14000_0x1400c[0xc];				 
	u32 signal_notify1;					 
	u8  pad_0x14010_0x1c00c[0x7ffc];			 
	u32 signal_notify2;					 
} __attribute__ ((aligned(0x20000)));
struct spu_priv2 {
	u8  pad_0x0000_0x1100[0x1100 - 0x0000]; 		 
	u8  pad_0x1100_0x1108[0x8];				 
	u64 slb_index_W;					 
...
#define SLB_VSID_VIRTUAL_PAGE_SIZE_MASK	(0x1ull << 6)
	...
	u8  pad_0x1130_0x2000[0x2000 - 0x1130]; 		 
	struct mfc_cq_sr spuq[16];				 
	struct mfc_cq_sr puq[8];				 
	u8  pad_0x2300_0x3000[0x3000 - 0x2300]; 		 
	u64 mfc_control_RW;					 
...
#define MFC_CNTL_DECREMENTER_STATUS_MASK	(1ull << 40)
	u8  pad_0x3008_0x4000[0x4000 - 0x3008]; 		 
	u64 puint_mb_R;						 
	u8  pad_0x4008_0x4040[0x4040 - 0x4008]; 		 
	u64 spu_privcntl_RW;					 
...
#define SPU_PRIVCNT_LOAD_REQUEST_ENABLE_MASK	(0x1ull << 2)
	u8  pad_0x4048_0x4058[0x10];				 
	u64 spu_lslr_RW;					 
	u64 spu_chnlcntptr_RW;					 
	u64 spu_chnlcnt_RW;					 
	u64 spu_chnldata_RW;					 
	u64 spu_cfg_RW;						 
	u8  pad_0x4080_0x5000[0x5000 - 0x4080]; 		 
...
#define MFC_DSISR_ADDRESS_OVERFLOW	(1 << 0)
	u8  pad_0x618_0x620[0x8];				 
	u64 mfc_dar_RW;						 
	u8  pad_0x628_0x700[0x700 - 0x628];			 
	u64 rmt_index_RW;					 
	u8  pad_0x708_0x710[0x8];				 
	u64 rmt_data1_RW;					 
	u8  pad_0x718_0x800[0x800 - 0x718];			 
	u64 mfc_dsir_R;						 
...
#define MFC_TCLASS_QUOTA_0_MASK		(0x1FL << MFC_TCLASS_QUOTA_0_SHIFT)
	u8  pad_0x828_0x900[0x900 - 0x828];			 
	u64 mfc_rm_boundary;					 
	u8  pad_0x908_0x938[0x30];				 
...
#define smm_sig_bus2_bits	(0x1LL << smm_sig_shift)
	u8  pad_0xa40_0xc00[0xc00 - 0xa40];			 
	u64 mfc_cer_R;						 
#define MFC_CER_Q		(1 << 31)
#define MFC_CER_SPU_QUEUE	MFC_CER_Q
	u8  pad_0xc08_0x1000[0x1000 - 0xc08];			 
	u64 spu_ecc_cntl_RW;					 
...
#define SPU_ERR_ILLEGAL_CHANNEL		(1ull << 1ul)
	u8  pad_0x1020_0x1028[0x1028 - 0x1020];			 
	u64 spu_trig0_sel;					 
	u64 spu_trig1_sel;					 
	u64 spu_trig2_sel;					 
	u64 spu_trig3_sel;					 
