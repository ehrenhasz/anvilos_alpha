...
#define OPAL_OLD_I2C_REQUEST			106	 
...
#define QUIESCE_HOLD			1  
#define QUIESCE_REJECT			2  
#define QUIESCE_LOCK_BREAK		3  
#define QUIESCE_RESUME			4  
#define QUIESCE_RESUME_FAST_REBOOT	5  
...
enum OpalSlotLedType {
	OPAL_SLOT_LED_TYPE_ID = 0,	 
	OPAL_SLOT_LED_TYPE_FAULT = 1,	 
	OPAL_SLOT_LED_TYPE_ATTN = 2,	 
	OPAL_SLOT_LED_TYPE_MAX = 3
};
enum OpalSlotLedState {
	OPAL_SLOT_LED_STATE_OFF = 0,	 
	OPAL_SLOT_LED_STATE_ON = 1	 
};
...
enum {
	OPAL_HMI_FLAGS_TB_RESYNC	= (1ull << 0),  
	OPAL_HMI_FLAGS_DEC_LOST		= (1ull << 1),  
	OPAL_HMI_FLAGS_HDEC_LOST	= (1ull << 2),  
	OPAL_HMI_FLAGS_TOD_TB_FAIL	= (1ull << 3),  
	OPAL_HMI_FLAGS_NEW_EVENT	= (1ull << 63),  
};
enum {
...
enum OpalSysPower {
	OPAL_SYSPOWER_UPS	= 0x0001,  
	OPAL_SYSPOWER_CHNG	= 0x0002,  
	OPAL_SYSPOWER_FAIL	= 0x0004,  
	OPAL_SYSPOWER_INCL	= 0x0008,  
};
enum OpalSysTemp {
	OPAL_SYSTEMP_AMB	= 0x0001,  
	OPAL_SYSTEMP_INT	= 0x0002,  
	OPAL_SYSTEMP_HMD	= 0x0004,  
};
enum OpalSysCooling {
	OPAL_SYSCOOL_INSF	= 0x0001,  
};
enum {
...
enum {
	XIVE_SYNC_EAS			= 0x00000001,  
	XIVE_SYNC_QUEUE			= 0x00000002,  
};
enum {
	XIVE_DUMP_TM_HYP	= 0,
	XIVE_DUMP_TM_POOL	= 1,
