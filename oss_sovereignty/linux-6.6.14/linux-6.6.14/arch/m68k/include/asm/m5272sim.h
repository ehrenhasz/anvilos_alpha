...
#define	MCFSIM_SCR		(MCF_MBAR + 0x04)	 
#define	MCFSIM_SPR		(MCF_MBAR + 0x06)	 
#define	MCFSIM_PMR		(MCF_MBAR + 0x08)	 
#define	MCFSIM_APMR		(MCF_MBAR + 0x0e)	 
#define	MCFSIM_DIR		(MCF_MBAR + 0x10)	 
#define	MCFSIM_ICR1		(MCF_MBAR + 0x20)	 
#define	MCFSIM_ICR2		(MCF_MBAR + 0x24)	 
#define	MCFSIM_ICR3		(MCF_MBAR + 0x28)	 
#define	MCFSIM_ICR4		(MCF_MBAR + 0x2c)	 
#define	MCFSIM_ISR		(MCF_MBAR + 0x30)	 
#define	MCFSIM_PITR		(MCF_MBAR + 0x34)	 
#define	MCFSIM_PIWR		(MCF_MBAR + 0x38)	 
#define	MCFSIM_PIVR		(MCF_MBAR + 0x3f)	 
#define	MCFSIM_WRRR		(MCF_MBAR + 0x280)	 
#define	MCFSIM_WIRR		(MCF_MBAR + 0x284)	 
#define	MCFSIM_WCR		(MCF_MBAR + 0x288)	 
#define	MCFSIM_WER		(MCF_MBAR + 0x28c)	 
#define	MCFSIM_CSBR0		(MCF_MBAR + 0x40)	 
#define	MCFSIM_CSOR0		(MCF_MBAR + 0x44)	 
#define	MCFSIM_CSBR1		(MCF_MBAR + 0x48)	 
#define	MCFSIM_CSOR1		(MCF_MBAR + 0x4c)	 
#define	MCFSIM_CSBR2		(MCF_MBAR + 0x50)	 
#define	MCFSIM_CSOR2		(MCF_MBAR + 0x54)	 
#define	MCFSIM_CSBR3		(MCF_MBAR + 0x58)	 
#define	MCFSIM_CSOR3		(MCF_MBAR + 0x5c)	 
#define	MCFSIM_CSBR4		(MCF_MBAR + 0x60)	 
#define	MCFSIM_CSOR4		(MCF_MBAR + 0x64)	 
#define	MCFSIM_CSBR5		(MCF_MBAR + 0x68)	 
#define	MCFSIM_CSOR5		(MCF_MBAR + 0x6c)	 
#define	MCFSIM_CSBR6		(MCF_MBAR + 0x70)	 
#define	MCFSIM_CSOR6		(MCF_MBAR + 0x74)	 
#define	MCFSIM_CSBR7		(MCF_MBAR + 0x78)	 
#define	MCFSIM_CSOR7		(MCF_MBAR + 0x7c)	 
#define	MCFSIM_SDCR		(MCF_MBAR + 0x180)	 
#define	MCFSIM_SDTR		(MCF_MBAR + 0x184)	 
#define	MCFSIM_DCAR0		(MCF_MBAR + 0x4c)	 
#define	MCFSIM_DCMR0		(MCF_MBAR + 0x50)	 
#define	MCFSIM_DCCR0		(MCF_MBAR + 0x57)	 
#define	MCFSIM_DCAR1		(MCF_MBAR + 0x58)	 
#define	MCFSIM_DCMR1		(MCF_MBAR + 0x5c)	 
#define	MCFSIM_DCCR1		(MCF_MBAR + 0x63)	 
