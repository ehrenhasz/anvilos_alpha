...
struct loongson_special_attribute {
	u16 vers;      
	char special_name[64];  
	u32 loongson_special_type;  
	struct resource_loongson resource[MAX_RESOURCE_NUMBER];
};
struct loongson_params {
	...
	u64 system_offset;	 
	u64 irq_offset;		 
	u64 interface_offset;	 
	u64 special_offset;	 
	u64 boarddev_table_offset;   
};
