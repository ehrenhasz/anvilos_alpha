...
#define KN4K_MB_INR_MT		3	 
#define KN4K_MB_INR_RES_2	2	 
#define KN4K_MB_INR_RTC		1	 
#define KN4K_MB_INR_TC		0	 
#define KN4K_MB_INT_IRQ		(0x1f<<0)	 
#define KN4K_MB_INT_IRQ_N(n)	(1<<(n))	 
...
#define KN4K_MB_CSR_MSK_N(n)	(1<<((n)+16))	 
