...
struct _ieee754_csr {
	__BITFIELD_FIELD(unsigned fcc:7,	 
	__BITFIELD_FIELD(unsigned nod:1,	 
	__BITFIELD_FIELD(unsigned c:1,		 
	__BITFIELD_FIELD(unsigned pad0:3,
	__BITFIELD_FIELD(unsigned abs2008:1,	 
	__BITFIELD_FIELD(unsigned nan2008:1,	 
	__BITFIELD_FIELD(unsigned cx:6,		 
	__BITFIELD_FIELD(unsigned mx:5,		 
	__BITFIELD_FIELD(unsigned sx:5,		 
	__BITFIELD_FIELD(unsigned rm:2,		 
	;))))))))))
};
