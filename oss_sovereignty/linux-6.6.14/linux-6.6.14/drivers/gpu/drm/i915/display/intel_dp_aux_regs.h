...
#define DP_AUX_CH_DATA(aux_ch, i)	_MMIO(_PORT(aux_ch, _DPA_AUX_CH_DATA1, _DPB_AUX_CH_DATA1) + (i) * 4)  
...
#define   DP_AUX_CH_CTL_TIME_OUT_MAX		REG_FIELD_PREP(DP_AUX_CH_CTL_TIME_OUT_MASK, 3)  
...
#define   DP_AUX_CH_CTL_PSR_DATA_AUX_REG_SKL	REG_BIT(14)  
#define   DP_AUX_CH_CTL_SYNC_TEST		REG_BIT(13)  
#define   DP_AUX_CH_CTL_FS_DATA_AUX_REG_SKL	REG_BIT(13)  
#define   DP_AUX_CH_CTL_DEGLITCH_TEST		REG_BIT(12)  
#define   DP_AUX_CH_CTL_GTC_DATA_AUX_REG_SKL	REG_BIT(12)  
#define   DP_AUX_CH_CTL_PRECHARGE_TEST		REG_BIT(11)  
#define   DP_AUX_CH_CTL_TBT_IO			REG_BIT(11)  
