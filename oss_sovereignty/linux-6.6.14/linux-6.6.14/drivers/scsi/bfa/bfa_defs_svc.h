...
struct bfa_fw_ioim_stats_s {
	...
	u32	wait_for_si;		 
	u32	rec_rsp_inval;		 
	u32     rec_rsp_xchg_comp;	 
	u32     rec_rsp_rd_si_ownd;	 
	u32	seqr_io_abort;		 
	u32	seqr_io_retry;		 
...
enum bfa_bbcr_err_reason {
	BFA_BBCR_ERR_REASON_NONE,  
	BFA_BBCR_ERR_REASON_SPEED_UNSUP,  
	BFA_BBCR_ERR_REASON_PEER_UNSUP,	 
	BFA_BBCR_ERR_REASON_NON_BRCD_SW,  
	BFA_BBCR_ERR_REASON_FLOGI_RJT,  
};
