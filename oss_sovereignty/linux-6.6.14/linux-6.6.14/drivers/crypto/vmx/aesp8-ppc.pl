...
Load_ctr32_enc_key:
	...
	subi		$inp,$inp,15		
	$SHL		$len,$len,4
	vadduqm		$out1,$ivec,$one	
	vadduqm		$out2,$ivec,$two	
	vxor		$out0,$ivec,$rndkey0	
	 le?li		$idx,8
...
Lxts_enc:
	...
	subi		$rounds,$rounds,1
	li		$idx,16
	vslb		$eighty7,$seven,$seven		
	vor		$eighty7,$eighty7,$seven	
	vspltisb	$tmp,1				
	vsldoi		$eighty7,$eighty7,$tmp,15	
	${UCMP}i	$len,96
