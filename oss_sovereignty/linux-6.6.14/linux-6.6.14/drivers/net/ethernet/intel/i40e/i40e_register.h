...
#define I40E_PRTDCB_TCMSTC(_i) (0x000A0040 + ((_i) * 32))    
...
#define I40E_PRTDCB_TCWSTC(_i) (0x000A2040 + ((_i) * 32))    
...
#define I40E_GLGEN_VFLRSTAT(_i) (0x00092600 + ((_i) * 4))    
...
#define I40E_GLLAN_TXPRE_QDIS(_i) (0x000e6500 + ((_i) * 4))    
...
#define I40E_QRX_ENA(_Q) (0x00120000 + ((_Q) * 4))    
...
#define I40E_QRX_TAIL(_Q) (0x00128000 + ((_Q) * 4))    
#define I40E_QTX_CTL(_Q) (0x00104000 + ((_Q) * 4))    
...
#define I40E_QTX_ENA(_Q) (0x00100000 + ((_Q) * 4))    
...
#define I40E_QTX_TAIL(_Q) (0x00108000 + ((_Q) * 4))    
...
#define I40E_PRTRPB_SLT(_i) (0x000AC5A0 + ((_i) * 32))    
...
#define I40E_GLQF_HKEY(_i) (0x00270140 + ((_i) * 4))    
#define I40E_GLQF_HKEY_MAX_INDEX 12
#define I40E_GLQF_PCNT(_i) (0x00266800 + ((_i) * 4))    
...
#define I40E_PFQF_HKEY(_i) (0x00244800 + ((_i) * 128))    
#define I40E_PFQF_HKEY_MAX_INDEX 12
#define I40E_PFQF_HLUT(_i) (0x00240000 + ((_i) * 128))    
...
#define I40E_GLPRT_BPRCH(_i) (0x003005E4 + ((_i) * 8))    
#define I40E_GLPRT_BPRCL(_i) (0x003005E0 + ((_i) * 8))    
#define I40E_GLPRT_BPTCH(_i) (0x00300A04 + ((_i) * 8))    
#define I40E_GLPRT_BPTCL(_i) (0x00300A00 + ((_i) * 8))    
#define I40E_GLPRT_CRCERRS(_i) (0x00300080 + ((_i) * 8))    
#define I40E_GLPRT_GORCH(_i) (0x00300004 + ((_i) * 8))    
#define I40E_GLPRT_GORCL(_i) (0x00300000 + ((_i) * 8))    
#define I40E_GLPRT_GOTCH(_i) (0x00300684 + ((_i) * 8))    
#define I40E_GLPRT_GOTCL(_i) (0x00300680 + ((_i) * 8))    
...
#define I40E_GLPRT_MLFC(_i) (0x00300020 + ((_i) * 8))    
#define I40E_GLPRT_MPRCH(_i) (0x003005C4 + ((_i) * 8))    
#define I40E_GLPRT_MPRCL(_i) (0x003005C0 + ((_i) * 8))    
#define I40E_GLPRT_MPTCH(_i) (0x003009E4 + ((_i) * 8))    
#define I40E_GLPRT_MPTCL(_i) (0x003009E0 + ((_i) * 8))    
#define I40E_GLPRT_MRFC(_i) (0x00300040 + ((_i) * 8))    
...
#define I40E_GLPRT_PRC64H(_i) (0x00300484 + ((_i) * 8))    
#define I40E_GLPRT_PRC64L(_i) (0x00300480 + ((_i) * 8))    
...
#define I40E_GLPRT_PTC64H(_i) (0x003006A4 + ((_i) * 8))    
#define I40E_GLPRT_PTC64L(_i) (0x003006A0 + ((_i) * 8))    
...
#define I40E_GLPRT_RDPC(_i) (0x00300600 + ((_i) * 8))    
#define I40E_GLPRT_RFC(_i) (0x00300560 + ((_i) * 8))    
#define I40E_GLPRT_RJC(_i) (0x00300580 + ((_i) * 8))    
#define I40E_GLPRT_RLEC(_i) (0x003000A0 + ((_i) * 8))    
#define I40E_GLPRT_ROC(_i) (0x00300120 + ((_i) * 8))    
#define I40E_GLPRT_RUC(_i) (0x00300100 + ((_i) * 8))    
#define I40E_GLPRT_RXON2OFFCNT(_i, _j) (0x00300380 + ((_i) * 8 + (_j) * 32))    
#define I40E_GLPRT_TDOLD(_i) (0x00300A20 + ((_i) * 8))    
#define I40E_GLPRT_UPRCH(_i) (0x003005A4 + ((_i) * 8))    
#define I40E_GLPRT_UPRCL(_i) (0x003005A0 + ((_i) * 8))    
#define I40E_GLPRT_UPTCH(_i) (0x003009C4 + ((_i) * 8))    
#define I40E_GLPRT_UPTCL(_i) (0x003009C0 + ((_i) * 8))    
#define I40E_GLSW_BPRCH(_i) (0x00370104 + ((_i) * 8))    
#define I40E_GLSW_BPRCL(_i) (0x00370100 + ((_i) * 8))    
#define I40E_GLSW_BPTCH(_i) (0x00340104 + ((_i) * 8))    
#define I40E_GLSW_BPTCL(_i) (0x00340100 + ((_i) * 8))    
#define I40E_GLSW_GORCH(_i) (0x0035C004 + ((_i) * 8))    
#define I40E_GLSW_GORCL(_i) (0x0035c000 + ((_i) * 8))    
#define I40E_GLSW_GOTCH(_i) (0x0032C004 + ((_i) * 8))    
#define I40E_GLSW_GOTCL(_i) (0x0032c000 + ((_i) * 8))    
#define I40E_GLSW_MPRCH(_i) (0x00370084 + ((_i) * 8))    
#define I40E_GLSW_MPRCL(_i) (0x00370080 + ((_i) * 8))    
#define I40E_GLSW_MPTCH(_i) (0x00340084 + ((_i) * 8))    
#define I40E_GLSW_MPTCL(_i) (0x00340080 + ((_i) * 8))    
#define I40E_GLSW_RUPP(_i) (0x00370180 + ((_i) * 8))    
#define I40E_GLSW_TDPC(_i) (0x00348000 + ((_i) * 8))    
#define I40E_GLSW_UPRCH(_i) (0x00370004 + ((_i) * 8))    
#define I40E_GLSW_UPRCL(_i) (0x00370000 + ((_i) * 8))    
#define I40E_GLSW_UPTCH(_i) (0x00340004 + ((_i) * 8))    
#define I40E_GLSW_UPTCL(_i) (0x00340000 + ((_i) * 8))    
#define I40E_GLV_BPRCH(_i) (0x0036D804 + ((_i) * 8))    
#define I40E_GLV_BPRCL(_i) (0x0036d800 + ((_i) * 8))    
#define I40E_GLV_BPTCH(_i) (0x0033D804 + ((_i) * 8))    
#define I40E_GLV_BPTCL(_i) (0x0033d800 + ((_i) * 8))    
#define I40E_GLV_GORCH(_i) (0x00358004 + ((_i) * 8))    
#define I40E_GLV_GORCL(_i) (0x00358000 + ((_i) * 8))    
#define I40E_GLV_GOTCH(_i) (0x00328004 + ((_i) * 8))    
#define I40E_GLV_GOTCL(_i) (0x00328000 + ((_i) * 8))    
#define I40E_GLV_MPRCH(_i) (0x0036CC04 + ((_i) * 8))    
#define I40E_GLV_MPRCL(_i) (0x0036cc00 + ((_i) * 8))    
#define I40E_GLV_MPTCH(_i) (0x0033CC04 + ((_i) * 8))    
#define I40E_GLV_MPTCL(_i) (0x0033cc00 + ((_i) * 8))    
#define I40E_GLV_RDPC(_i) (0x00310000 + ((_i) * 8))    
#define I40E_GLV_RUPP(_i) (0x0036E400 + ((_i) * 8))    
#define I40E_GLV_TEPC(_i) (0x00344000 + ((_i) * 8))    
#define I40E_GLV_UPRCH(_i) (0x0036C004 + ((_i) * 8))    
#define I40E_GLV_UPRCL(_i) (0x0036c000 + ((_i) * 8))    
#define I40E_GLV_UPTCH(_i) (0x0033C004 + ((_i) * 8))    
#define I40E_GLV_UPTCL(_i) (0x0033c000 + ((_i) * 8))    
...
#define I40E_VP_MDET_RX(_VF) (0x0012A000 + ((_VF) * 4))    
#define I40E_VP_MDET_RX_VALID_SHIFT 0
#define I40E_VP_MDET_RX_VALID_MASK I40E_MASK(0x1, I40E_VP_MDET_RX_VALID_SHIFT)
#define I40E_VP_MDET_TX(_VF) (0x000E6000 + ((_VF) * 4))    
...
#define I40E_GLQF_FDEVICTENA(_i) (0x00270384 + ((_i) * 4))    
#define I40E_GLGEN_STAT_CLEAR 0x00390004  
#endif  
