...
#define MISENSOR_TOK_TERM	0xf000	 
#define MISENSOR_TOK_DELAY	0xfe00	 
#define MISENSOR_TOK_FWLOAD	0xfd00	 
#define MISENSOR_TOK_POLL	0xfc00	 
#define MISENSOR_TOK_RMW	0x0010   
#define MISENSOR_TOK_MASK	0xfff0
#define MISENSOR_AWB_STEADY	BIT(0)	 
#define MISENSOR_AE_READY	BIT(3)	 
...
#define REG_V_START                     0xc800  
#define REG_H_START                     0xc802  
#define REG_V_END                       0xc804  
#define REG_H_END                       0xc806  
#define REG_PIXEL_CLK                   0xc808  
#define REG_TIMING_VTS                  0xc812  
#define REG_TIMING_HTS                  0xc814  
#define REG_WIDTH                       0xC868  
#define REG_HEIGHT                      0xC86A  
#define REG_EXPO_COARSE                 0x3012  
...
#define MT9M114_FOCAL_LENGTH_NUM	208	 
...
static struct misensor_reg const mt9m114_960P_init[] = {
	...
	{MISENSOR_16BIT, 0xC804, 0x03CF},  
	{MISENSOR_16BIT, 0xC806, 0x050F},  
	{MISENSOR_16BIT, 0xC808, 0x02DC},  
	...
	{MISENSOR_16BIT, 0xC858, 0x0508},  
	{MISENSOR_16BIT, 0xC85A, 0x03C8},  
	{MISENSOR_8BIT,  0xC85C, 0x03},    
	{MISENSOR_16BIT, 0xC868, 0x0508},  
	{MISENSOR_16BIT, 0xC86A, 0x03C8},  
	{MISENSOR_TOK_TERM, 0, 0},
};
#endif
...
static struct misensor_reg const mt9m114_864P_init[] = {
	...
	{MISENSOR_16BIT, 0xC980, 0x0128},  
	{MISENSOR_16BIT, 0xC982, 0x0700},  
	{MISENSOR_16BIT, 0xC800, 0x0038},  
	{MISENSOR_16BIT, 0xC802, 0x0000},  
	{MISENSOR_16BIT, 0xC804, 0x0397},  
	{MISENSOR_16BIT, 0xC806, 0x050F},  
	{MISENSOR_32BIT, 0xC808, 0x2DC6C00},
	{MISENSOR_16BIT, 0xC80C, 0x0001},  
	{MISENSOR_16BIT, 0xC80E, 0x00DB},
	...
	{MISENSOR_16BIT, 0xC856, 0x0000},  
	{MISENSOR_16BIT, 0xC858, 0x0508},  
	{MISENSOR_16BIT, 0xC85A, 0x0358},  
	{MISENSOR_8BIT, 0xC85C, 0x03},  
	{MISENSOR_16BIT, 0xC868, 0x0508},  
	{MISENSOR_16BIT, 0xC86A, 0x0358},  
	{MISENSOR_8BIT, 0xC878, 0x00},  
	{MISENSOR_TOK_TERM, 0, 0}
};
static struct misensor_reg const mt9m114_736P_init[] = {
	{MISENSOR_16BIT, 0x98E, 0x1000},
	{MISENSOR_8BIT, 0xC97E, 0x01},	   
	{MISENSOR_16BIT, 0xC980, 0x011F},  
	{MISENSOR_16BIT, 0xC982, 0x0700},  
	{MISENSOR_16BIT, 0xC800, 0x0078},  
	{MISENSOR_16BIT, 0xC802, 0x0000},  
	{MISENSOR_16BIT, 0xC804, 0x0357},  
	{MISENSOR_16BIT, 0xC806, 0x050F},  
	{MISENSOR_32BIT, 0xC808, 0x237A07F},  
	{MISENSOR_16BIT, 0xC80C, 0x0001},  
	{MISENSOR_16BIT, 0xC80E, 0x00DB},
	{MISENSOR_16BIT, 0xC810, 0x05BD},
	...
	{MISENSOR_16BIT, 0xC856, 0x0000},  
	{MISENSOR_16BIT, 0xC858, 0x0508},  
	{MISENSOR_16BIT, 0xC85A, 0x02D8},  
	{MISENSOR_8BIT, 0xC85C, 0x03},  
	{MISENSOR_16BIT, 0xC868, 0x0508},  
	{MISENSOR_16BIT, 0xC86A, 0x02D8},  
	{MISENSOR_8BIT, 0xC878, 0x00},  
	{MISENSOR_TOK_TERM, 0, 0}
};
#if 0  
static struct misensor_reg const mt9m114_720_480P_init[] = {
	...
	{MISENSOR_16BIT, 0xC980, 0x0128},  
	{MISENSOR_16BIT, 0xC982, 0x0700},  
	{MISENSOR_16BIT, 0xC800, 0x00F0},  
	{MISENSOR_16BIT, 0xC802, 0x0118},  
	{MISENSOR_16BIT, 0xC804, 0x02DF},  
	{MISENSOR_16BIT, 0xC806, 0x03F7},  
	{MISENSOR_32BIT, 0xC808, 0x2DC6C00},
	{MISENSOR_16BIT, 0xC80C, 0x0001},  
	{MISENSOR_16BIT, 0xC80E, 0x00DB},
	{MISENSOR_16BIT, 0xC810, 0x05B3},
	...
	{MISENSOR_16BIT, 0xC854, 0x0000},  
	{MISENSOR_16BIT, 0xC856, 0x0000},  
	{MISENSOR_16BIT, 0xC858, 0x02D8},  
	{MISENSOR_16BIT, 0xC85A, 0x01E8},  
	{MISENSOR_8BIT, 0xC85C, 0x03},  
	{MISENSOR_16BIT, 0xC868, 0x02D8},  
	{MISENSOR_16BIT, 0xC86A, 0x01E8},  
	{MISENSOR_8BIT, 0xC878, 0x00},  
	{MISENSOR_TOK_TERM, 0, 0}
};
#endif
static struct misensor_reg const mt9m114_common[] = {
	...
	{MISENSOR_16BIT, 0x3C5A, 0x0009},  
	{MISENSOR_16BIT, 0xC86C, 0x0210},  
	{MISENSOR_16BIT, 0xA804, 0x0000},  
	{MISENSOR_16BIT, 0x3012, 0x0110},  
	{MISENSOR_TOK_TERM, 0, 0},
};
#if 0  
