...
static const struct snd_pci_quirk alc880_fixup_tbl[] = {
	...
	SND_PCI_QUIRK(0x2668, 0x8086, NULL, ALC880_FIXUP_6ST_DIG),  
...
static const struct coef_fw alc282_coefs[] = {
	WRITE_COEF(0x03, 0x0002),  
	UPDATE_COEF(0x05, 0xff3f, 0x0700),  
	WRITE_COEF(0x07, 0x0200),  
	UPDATE_COEF(0x06, 0x00f0, 0),  
	UPDATE_COEF(0x08, 0xfffc, 0x0c2c),  
	WRITE_COEF(0x0a, 0xcccc),  
	WRITE_COEF(0x0b, 0xcccc),  
	WRITE_COEF(0x0e, 0x6e00),  
	UPDATE_COEF(0x0f, 0xf800, 0x1000),  
	UPDATE_COEF(0x10, 0xfc00, 0x0c00),  
	WRITE_COEF(0x6f, 0x0),  
	UPDATE_COEF(0x0c, 0xfe00, 0),  
	WRITE_COEF(0x34, 0xa0c0),  
	UPDATE_COEF(0x16, 0x0008, 0),  
	UPDATE_COEF(0x1d, 0x00e0, 0),  
	UPDATE_COEF(0x1f, 0x00e0, 0),  
	WRITE_COEF(0x21, 0x8804),  
	WRITE_COEF(0x63, 0x2902),  
	WRITE_COEF(0x68, 0xa080),  
	WRITE_COEF(0x69, 0x3400),  
	WRITE_COEF(0x6a, 0x2f3e),  
	WRITE_COEF(0x6b, 0x0),  
	UPDATE_COEF(0x6d, 0x0fff, 0x0900),  
	WRITE_COEF(0x6e, 0x110a),  
	UPDATE_COEF(0x70, 0x00f8, 0x00d8),  
	WRITE_COEF(0x71, 0x0014),  
	WRITE_COEF(0x72, 0xc2ba),  
	UPDATE_COEF(0x77, 0x0f80, 0),  
	WRITE_COEF(0x6c, 0xfc06),  
	{}
};
...
static const struct coef_fw alc283_coefs[] = {
	...
	WRITE_COEF(0x0a, 0xcccc),  
	WRITE_COEF(0x0b, 0xcccc),  
	WRITE_COEF(0x0e, 0x6fc0),  
	UPDATE_COEF(0x0f, 0xf800, 0x1000),  
	UPDATE_COEF(0x10, 0xfc00, 0x0c00),  
	WRITE_COEF(0x3a, 0x0),  
	UPDATE_COEF(0x0c, 0xfe00, 0x0),  
	WRITE_COEF(0x22, 0xa0c0),  
	UPDATE_COEFEX(0x53, 0x01, 0x000f, 0x0008),  
	UPDATE_COEF(0x1d, 0x00e0, 0),  
	UPDATE_COEF(0x1f, 0x00e0, 0),  
	WRITE_COEF(0x21, 0x8804),  
	WRITE_COEF(0x2e, 0x2902),  
	WRITE_COEF(0x33, 0xa080),  
	WRITE_COEF(0x34, 0x3400),  
	WRITE_COEF(0x35, 0x2f3e),  
	WRITE_COEF(0x36, 0x0),  
	UPDATE_COEF(0x38, 0x0fff, 0x0900),  
	WRITE_COEF(0x39, 0x110a),  
	UPDATE_COEF(0x3b, 0x00f8, 0x00d8),  
	WRITE_COEF(0x3c, 0x0014),  
	WRITE_COEF(0x3d, 0xc2ba),  
	UPDATE_COEF(0x42, 0x0f80, 0x0),  
	WRITE_COEF(0x49, 0x0),  
	UPDATE_COEF(0x40, 0xf800, 0x9800),  
	UPDATE_COEF(0x42, 0xf000, 0x2000),  
	WRITE_COEF(0x37, 0xfc06),  
...
static void alc285_hp_init(struct hda_codec *codec)
{
	...
	coef38 = alc_read_coef_idx(codec, 0x38);  
	coef0d = alc_read_coef_idx(codec, 0x0d);  
	coef36 = alc_read_coef_idx(codec, 0x36);  
	...
	if (hp_pin)
		snd_hda_codec_write(codec, hp_pin, 0,
			    AC_VERB_SET_PIN_WIDGET_CONTROL, 0x0);
	msleep(10);
	alc_write_coef_idx(codec, 0x67, 0x0);  
	...
	alc_write_coefex_idx(codec, 0x58, 0x00, 0xf888);  
...
#ifdef HALT_REALTEK_ALC5505
#define alc5505_dsp_suspend(codec)	do { } while (0)  
#define alc5505_dsp_resume(codec)	do { } while (0)  
#else
...
static const struct snd_pci_quirk alc269_fixup_tbl[] = {
	...
	SND_PCI_QUIRK(0x1b7d, 0xa831, "Ordissimo EVE2 ", ALC269VB_FIXUP_ORDISSIMO_EVE2),  
