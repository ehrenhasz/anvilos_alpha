...
#define CFG_ERR_SPI_FRAME          0x00000001  
#define CFG_ERR_SDIO_BUF_MISMATCH  0x00000001  
...
#define CFG_ERR_HOST_CRC_MISS      0x00000080  
#define CFG_SPI_IGNORE_CS          0x00000080  
#define CFG_BYTE_ORDER_MASK        0x00000300  
#define     CFG_BYTE_ORDER_BADC    0x00000000
#define     CFG_BYTE_ORDER_DCBA    0x00000100
#define     CFG_BYTE_ORDER_ABCD    0x00000200  
