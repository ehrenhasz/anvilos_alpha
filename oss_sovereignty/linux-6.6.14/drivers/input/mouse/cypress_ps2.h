...
#define CYTP_CMD_STANDARD_MODE              ENCODE_CMD(0, 2, 0, 0)   
#define CYTP_CMD_CYPRESS_REL_MODE           ENCODE_CMD(1, 1, 1, 1)   
...
#define DFLT_RESP_BITS_VALID     0x88   
