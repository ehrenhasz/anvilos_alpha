...
# define IF_VARIABLE_ARCH_PAGESIZE(...)  
...
#if ENABLE_SELINUX
	FILEUTILS_PRESERVE_SECURITY_CONTEXT = 1 << 17,  
#endif
#define FILEUTILS_CP_OPTSTR "pdRfinlsLHarPvuTt:" IF_SELINUX("c")
	FILEUTILS_CP_OPTBITS      = 18 - !ENABLE_SELINUX,
	FILEUTILS_RMDEST          = 1 << (19 - !ENABLE_SELINUX),  
	FILEUTILS_REFLINK         = 1 << (20 - !ENABLE_SELINUX),  
	FILEUTILS_REFLINK_ALWAYS  = 1 << (21 - !ENABLE_SELINUX),  
#if ENABLE_SELINUX
...
void setsockopt_reuseaddr(int fd) FAST_FUNC;  
...
struct aftype {
	...
	int         FAST_FUNC (*input)(  const char *bufp, struct sockaddr *);
...
enum {
	...
	PARSE_ALT_COMMENTS = 0x00800000,  
	PARSE_WS_COMMENTS  = 0x01000000,  
...
extern const char bb_PATH_root_path[] ALIGN1;  
