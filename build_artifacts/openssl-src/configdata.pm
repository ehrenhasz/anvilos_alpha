    ...
    "dirinfo" => {
        ...
        "crypto/thread" => {
            "deps" => [
                ...
                "crypto/thread/libssl-lib-arch.o"
            ],
            "products" => {
                "lib" => [
                    "libcrypto",
        ...
        "crypto/thread/arch" => {
            "deps" => [
                "crypto/thread/arch/libssl-lib-thread_none.o",
...
unless (caller) {
    ...
    use lib '/home/aimeat/anvilos/build_artifacts/openssl-src/util/perl';
    use OpenSSL::fallback '/home/aimeat/anvilos/build_artifacts/openssl-src/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/aimeat/anvilos/build_artifacts/openssl-src/Configurations';
        use gentemplate;
