...
BEGIN {
    ...
    require '/home/aimeat/anvilos/build_artifacts/openssl-src/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/aimeat/anvilos/build_artifacts/openssl-src/test/fips-and-base.cnf';
    shift;
